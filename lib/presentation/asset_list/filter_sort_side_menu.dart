...
class FilterSortSideMenu extends StatefulWidget {
  ...
  final AssetFilterType currentAssetType;
...
class _FilterSortSideMenuState extends State<FilterSortSideMenu> {
  ...
  late AssetFilterType _selectedAssetType;
  ...
  void initState() {
    ...
    _selectedAssetType = widget.currentAssetType;
  }
  ...
  void _confirmAndClose() {
    ...
    context.read<AssetListBloc>().add(
      SetFilterAndSortEvent(filter: changedFilter, sort: changedSort, assetType: _selectedAssetType)
    );
